...
class PropalsValidatedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                            ->subject('Les propositions pour votre création ' . $this->conception->type
                            . ' sont prêtes')
                            ->markdown('mail.user.propalsValidated', [
