...
class ModificationReceivedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                            ->subject('Le client ' . $this->conception->user->display_name
                                . ' demande une modification pour sa création ' . $this->conception->type 
                                )
                            ->markdown('mail.admin.modificationReceived', [
